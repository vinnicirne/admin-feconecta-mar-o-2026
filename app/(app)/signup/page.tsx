    ...
    <div style={{ 
      ...
      <div style={{ width: "100%", maxWidth: 420 }}>
        <div style={{ textAlign: "center", marginBottom: 32 }}>
           ...
           <h2 style={{ fontSize: 24, fontWeight: 900, margin: 0 }}>Criar sua conta no Refúgio</h2>
           <p className="muted" style={{ marginTop: 8 }}>Cadastre-se para compartilhar sua fé e edificar irmãos.</p>
        </div>
